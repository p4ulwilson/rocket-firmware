#!/bin/bash
# Rocket Routers Firmware E v3.11.7 — WSL Build Script
# Run from WSL: bash /mnt/d/Rocket-Routers-Website/firmware-build/build-v3.11.7.sh
#
# set -e / uci-delete fix. One change in this build, on top of v3.11.6:
#
